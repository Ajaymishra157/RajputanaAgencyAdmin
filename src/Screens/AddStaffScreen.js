        ...
        <View style={{ padding: 20 }}>
          ...
          <TextInput
            ...
            onChangeText={(text) => {
              setStaffName(text);
              if (text.trim() !== "") {
                setStaffNameError(null); // 👈 type karte hi error hata do
              }
            }}
          ...
          <Text
            ...
            Staff Mobile Number <Text style={{ color: 'red', fontFamily: 'Inter-Bold', }}>*</Text>
          </Text>
          <TextInput
            value={staffMobile}
            onChangeText={(text) => {
              ...
              if (text.trim().length > 0) {
                setStaffMobileError(null); // 👈 likhne par error hata do
              }
            }}
          ...
          <Text
            ...
            Staff Password <Text style={{ color: 'red', fontFamily: 'Inter-Bold', }}>*</Text>
          </Text>
          <View
            style={{
              position: 'relative',
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                ...
                if (text.trim().length > 0) {
                  setStaffPasswordError(null); // ✅ likhne par error hata do
                }
              }}
            />
            ...
            <TouchableOpacity
              ...
              <Image
                source={
                  showPassword
                    ? require('../assets/images/hide.png') // 👈 replace with your correct path
